package com.filip.eurekagallery.config;
...
public class SwaggerDocumentationConfiguration implements WebMvcConfigurer {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Gallery REST CRUD operations API in Spring-Boot 2")
                .description(
                ...
                .contact(
                        new Contact("Filip Vanden Eynde",
    ...
    public Docket configureControllerPackageAndConvertors() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.filip.eurekagallery"))
